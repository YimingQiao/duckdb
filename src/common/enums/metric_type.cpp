...
profiler_settings_t MetricsUtils::GetOptimizerMetrics() {
    return {
        ...
        MetricsType::OPTIMIZER_VECTOR_PULL_UP,
    };
}
...
MetricsType MetricsUtils::GetOptimizerMetricByType(OptimizerType type) {
    switch(type) {
        ...
        case OptimizerType::VECTOR_PULL_UP:
            return MetricsType::OPTIMIZER_VECTOR_PULL_UP;
       default:
...
OptimizerType MetricsUtils::GetOptimizerTypeByMetric(MetricsType type) {
    switch(type) {
        ...
        case MetricsType::OPTIMIZER_VECTOR_PULL_UP:
            return OptimizerType::VECTOR_PULL_UP;
    default:
